package generator.action.config;

import com.baomidou.mybatisplus.generator.config.rules.DbType;
import com.baomidou.mybatisplus.generator.config.rules.NamingStrategy;
import generator.action.model.GenQo;
import support.StrKit;
...
public class WebGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void config() {
        ...
        packageConfig.setEntity(genQo.getProjectPackage() + ".modular.gdca.model");
        packageConfig.setMapper(genQo.getProjectPackage() + ".modular.gdca.dao");
        packageConfig.setXml(genQo.getProjectPackage() + ".modular.gdca.dao.mapping");
